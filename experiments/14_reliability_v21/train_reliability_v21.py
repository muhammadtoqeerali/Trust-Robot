...
aug_path = Path(
    "experiments/14_reliability_v21/reliability_augmentation_v21.py"
)
...
for epoch in range(20):
    ...
    if acc>best:
        ...
        torch.save(
            model.state_dict(),
            f"models/reliability_v21/reliability_cnn_v2_{DATASET}.pt"
        )
...
Path(
f"results/reliability_v21/reliability_cnn_v2_{DATASET}_results.json"
).write_text(
    json.dumps(
        result,
        indent=2
