...
aug_path = Path(
    "experiments/15_reliability_v22/reliability_augmentation_v22.py"
)
...
for epoch in range(20):
    ...
    if acc>best:
        ...
        torch.save(
            model.state_dict(),
            f"models/reliability_v22/reliability_cnn_v22_{DATASET}.pt"
        )
...
Path(
f"results/reliability_v22/reliability_cnn_v2_{DATASET}_results.json"
).write_text(
    json.dumps(
        result,
        indent=2
