...
STAGE24_SNAPSHOT = (
    ...
    / "harness_patch2"
    / "run_storm_paper_domain_faults_r1.after_patch2.py"
)
...
def load_stage24():
    ...
    spec = importlib.util.spec_from_file_location(
        "stage24_frozen_patch2_for_v26_r9d1",
        STAGE24_SNAPSHOT,
    )
...
def run_smoke(
    ...
    write_json(
        out_dir
        / "v26_external_storm_test_smoke_receipt_r9d1.json",
        receipt,
    )


    print(
        "R9D1_STAGE24_CONDITION_MANIFEST_PASS_18=True"
    )

    print(
        "R9D1_SYNTHETIC_CONDITION_TENSOR_SHA_UNIQUE_18_OF_18=True"
    )

    print(
        "R9D1_CHECKPOINT_STRICT_LOAD_PASS_5_OF_5=True"
    )

    print(
        "R9D1_SYNTHETIC_FORWARD_PASS_5_OF_5=True"
    )

    print(
        "R9D1_PARAMETER_COUNT_PASS_23210=True"
    )
    ...
    print(
        "V26_EXTERNAL_STORM_TEST_SMOKE_R9D1_PASS=True"
    )
...
def run_full(
    ...
    print(
        "R9D1_EXTERNAL_TEST_SHAPE_PASS_13993x64x6=True",
        flush=True,
    )
    ...
    write_json(
        out_dir
        / "external_v26c_aggregate_summary_r9d1.json",
        aggregate,
    )
    ...
    receipt = {
        ...
        "next_gate":
            (
                ...
                "compare frozen V26C R9D1 aggregates/per-seed "
    ...
    write_json(
        out_dir
        / "v26_external_storm_test_receipt_r9d1.json",
        receipt,
    )
    ...
    print()
    print("=" * 118)
    print("V26 EXTERNAL STORM R9D1 FINAL RESULT")
    print("=" * 118)
    ...
    print()
    print(
        "R9D1_EXTERNAL_CASE_ROWS_PASS_90=True"
    )

    print(
        "R9D1_CONDITION_TENSOR_SHA_UNIQUE_18_OF_18=True"
    )

    print(
        "V26_EXTERNAL_STORM_TEST_R9D1_PASS=True"
    )
